...
class _ProductView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final formProductProvider = ref.watch(productFormProvider(product));
    ...
    return ListView(
      children: [
        SizedBox(
          height: 250,
          width: 600,
          child: _ImageGallery(images: formProductProvider.images),
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          _SizeSelector(
            ...
            onSizesChanges:
                ref.read(productFormProvider(product).notifier).onSizesChanges,
          ),
          const SizedBox(height: 5),
          _GenderSelector(
            selectedGender: productForm.gender,
            onGenderChanges:
                ref.read(productFormProvider(product).notifier).onGenderChanges,
          ),
          const SizedBox(height: 15),
          CustomProductField(
            isTopField: true,
...
class _GenderSelector extends StatelessWidget {
  ...
  const _GenderSelector(
      {required this.selectedGender, required this.onGenderChanges});
